    ...
    "paths": {
        ...
        "/api/wordpress-gbp": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "WordPress GBP一覧",
                        "schema": {
                            "$ref": "#/definitions/res.WordpressGbpList"
                        }
                    },
                    "400": {
                        "description": "不正なリクエスト",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/req.WordpressGbp"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "作成されたWordPress GBP",
                        "schema": {
                            "$ref": "#/definitions/res.WordpressGbp"
                        }
                    },
                    "400": {
                        "description": "不正なリクエスト",
        ...
        "/api/wordpress-gbp/{id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "WordPress GBP詳細",
                        "schema": {
                            "$ref": "#/definitions/res.WordpressGbpDetail"
                        }
                    },
                    "404": {
                        "description": "見つかりません",
            ...
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "更新されたWordPress GBP",
                        "schema": {
                            "$ref": "#/definitions/res.WordpressGbp"
                        }
                    },
